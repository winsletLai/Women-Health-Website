                ...
                <div className="sm:shadow-(--shadow-m) sm:px-8 w-screen sm:my-8 sm:h-fill sm:w-75 bg-linear-to-br from-bg to-rose-800/20 rounded-xl">
                    <div className="flex flex-col w-full items-center">
                        <div className='mt-8 flex'>
                            ...
                            <h1 className="text-text text-4xl">Login</h1>
                        </div>
                        <p className='text-center text-text-muted mt-4'>Don't have an account? <Link to="/register"> <span className='text-highlight underline'>Register</span> </Link></p>
                        {msg && (
